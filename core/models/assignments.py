...
class Assignment(db.Model):
    ...
    def upsert(cls, assignment_new: 'Assignment'):
        if assignment_new.id is not None:
            ...
            assertions.assert_valid(assignment_new.content is not None  and assignment_new.content.strip(),'Assignment content cannot be empty')
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        print(auth_principal.teacher_id)
        if auth_principal.teacher_id:
            assertions.assert_valid(assignment.teacher_id == auth_principal.teacher_id, f'Assignment assigned by {assignment.teacher_id } not {auth_principal.teacher_id}')
            ...
            assertions.assert_valid(assignment.state != AssignmentStateEnum.DRAFT, 'Only a submitted can be graded')
